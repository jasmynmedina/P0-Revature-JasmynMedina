...
/**
 * The data access object interface for CRUD operations on Accounts. This allows
 * us to define a contract which can be implemented in different ways using
 * different methods of data storage and retrieval.
 */
