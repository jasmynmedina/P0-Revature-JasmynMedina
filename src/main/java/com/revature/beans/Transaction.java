...
/**
 * An individual transaction that can be performed on an account. Can be a
 * withdrawal, deposit or transfer. For withdrawals or deposits, the toAccountId
 * field is null.
 */
public class Transaction implements Serializable {
	...
	public String toString() {
		return "Transaction [sender=" + fromAccountId + ", recipient=" + toAccountId + ", amount=" + amount + ", type="
