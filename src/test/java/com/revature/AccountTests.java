...
/**
 * These tests test the Account features. Remember that tests follow the AAA
 * pattern (arrange, act, assert). First we arrange the initial values and setup
 * any objects needed. Then we act - call the method we are testing. Finally we
 * assert that the final state is what we expected to happen.
 */
public class AccountTests extends PointWatcher {
	...
	public void testTransactionsAdded() {
		...
		// first account should record a transfer of 5 and have balance of 20 + starting
		// balance
		...
		// second account should record a transfer of 5 as well and have a balance of 5
		// + starting balance
