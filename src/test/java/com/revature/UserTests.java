...
public class UserTests extends PointWatcher {
	...
	public void setupMocks() {
		...
		// DAO layer will only retrieve "testuser" -> simulating only this user existing
	...
	/*
	 * This test uses mocking to test that the DAO layer is being called once to
	 * login
	 */
	@Test
	@Points(2)
	...
	/*
	 * This is an example of a negative test. Here, we want to ensure that we are
	 * properly rejecting invalid credentials and preventing unauthorized logins
	 */
